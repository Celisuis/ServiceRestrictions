...
namespace ServiceRestricter.GUI.Industries
{
    public class IndustriesPanel : UIPanel
    {
        ...
        private void Setup()
        {
            name = "ServiceRestricterRestrictIndustriesPanel";
            isVisible = false;
            canFocus = true;
            isInteractive = true;
            ...
            IndustriesPanelWrapper.Instance.relativePosition = new Vector3(ServiceResticterMod.Settings.PanelX, ServiceResticterMod.Settings.PanelY);
